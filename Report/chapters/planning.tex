...
\section{Initiële planning} \label{sec:initiele_planning}
De initiële planning is terug te vinden op figuur \ref{fig:initiele_planning}.
\begin{figure}[p]
	\centering
	...
	\end{ganttchart}
	\caption[Gantt chart van de initiële planning.]{Gantt chart van de initiële planning.}
