...
\section{Initi\"ele planning en taakverdeling} \label{sec:initiele_planning}
De initi\"ele planning is terug te vinden op figuur \ref{fig:initiele_planning}, terwijl de taakverdeling verduidelijkt staat in tabel \ref{tab:taakverdeling}.
\begin{figure}[p]
\centering
