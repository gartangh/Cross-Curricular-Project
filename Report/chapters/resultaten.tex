...
De stippellijnen op komen overeen met de tegels van de ruimte, deze zijn \SI{600}{\mm} $\times$ \SI{600}{\mm} groot.
De drone probeert de \textit{waypoints} de doorlopen in wijzerzin, met het linkerbovenhoek als startpunt. 
\begin{figure}[p]
	\centering
