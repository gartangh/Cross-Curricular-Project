\chapter{Resultaten}
Het belangrijkste resultaat is natuurlijk de implementatie van het volledige drone systeem. Hierbij worden locatieupdates met een frequentie van \SI{27.5}{\Hz} verkregen en wordt de drone aangestuurd met een frequentie van \SI{10}{\Hz}.\\
